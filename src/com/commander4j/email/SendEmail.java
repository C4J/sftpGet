...
{
	public Logger logger = org.apache.logging.log4j.LogManager.getLogger((SendEmail.class));
	...
	public synchronized boolean Send(String distributionID, String subject, String messageText, String filename)
	{
		...
		{
			logger.info("Email disabled in sftpGet.xml");
			return result;
		}
		...
		if (distList.containsKey(distributionID) == true)
		{
			...
			{
				logger.info("Email Distribution list ["+distributionID+"] is disabled.");

			}
		}
		else
		{
			logger.info("Disabled or empty email distribution list ["+distributionID+"]. No email sent.");
		}
